...
public class QWE extends Item {
    ...
    public QWE(){
        ...
        this.maxStackSize = 1;
        this.setUnlocalizedName("qwe");
        this.setTextureName(Reference.MOD_ID+":qwe");
    ...
    public ItemStack onItemRightClick(ItemStack p_77659_1_, World world, EntityPlayer player) {
        ...
        for(Object el : (world.getEntitiesWithinAABB(EntityLiving.class,AxisAlignedBB.getBoundingBox(pos.posX-10,pos.posY-2,pos.posZ-10,pos.posX+10,pos.posY+2,pos.posZ+10)))) {
            ((EntityLiving) el).setHealth(((EntityLiving) el).getHealth()-((EntityLiving) el).getTotalArmorValue()-1);
        }
        player.setHealth(player.getHealth()-((player.getTotalArmorValue()+1)/2));
