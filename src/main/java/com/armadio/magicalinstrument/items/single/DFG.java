...
public class DFG extends Item {
    ...
    public DFG(){
        ...
        this.maxStackSize = 1;
        this.setUnlocalizedName("dfg");
        this.setTextureName(Reference.MOD_ID+":dfg");
    ...
    public ItemStack onItemRightClick(ItemStack p_77659_1_, World world, EntityPlayer player) {
        ...
        for(Object el : (world.getEntitiesWithinAABB(EntitySheep.class, AxisAlignedBB.getBoundingBox(pos.posX - AREA, pos.posY - AREA, pos.posZ - AREA, pos.posX + AREA, pos.posY + AREA, pos.posZ + AREA)))) {
            ((EntitySheep) el).setFleeceColor(player.getRNG().nextInt(16));
        }
