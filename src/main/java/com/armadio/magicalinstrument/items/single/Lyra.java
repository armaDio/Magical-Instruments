 ...
 */
public class Lyra extends Item {
    ...
    public Lyra(){
        ...
        this.maxStackSize = 1;
        this.setUnlocalizedName("lyra");
        this.setTextureName(Reference.MOD_ID+":lyra");
    ...
    public ItemStack onItemRightClick(ItemStack p_77659_1_, World world, EntityPlayer player) {
        ...
        for(Object el : (world.getEntitiesWithinAABB(EntityChicken.class, AxisAlignedBB.getBoundingBox(pos.posX - AREA, pos.posY - AREA, pos.posZ - AREA, pos.posX + AREA, pos.posY + AREA, pos.posZ + AREA)))) {
            ((EntityChicken) el).timeUntilNextEgg=0;
        }
