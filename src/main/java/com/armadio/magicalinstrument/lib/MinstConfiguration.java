...
public class MinstConfiguration {
    ...
    public static final int T1DURATION_DEFAULT = 60;
    public static final String T1DURATION_DESCRIPTION = "Duration of the effect for T1 Instruments in seconds";
    public static int t2duration;
    public static final int T2DURATION_DEFAULT = 150;
    public static final String T2DURATION_DESCRIPTION = "Duration of the effect for T2 Instruments in seconds";
    public static int t3duration;
    public static final int T3DURATION_DEFAULT = 300;
    public static final String T3DURATION_DESCRIPTION = "Duration of the effect for T3 Instruments in seconds";
