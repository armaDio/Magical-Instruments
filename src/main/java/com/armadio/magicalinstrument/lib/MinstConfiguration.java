...
public class MinstConfiguration {
    ...
    public static final String T1DURATION_DESCRIPTION = "Duration of the effect for T1 Instruments";
    public static int t2duration;
    public static final int T2DURATION_DEFAULT = 3000;
    public static final String T2DURATION_DESCRIPTION = "Duration of the effect for T1 Instruments";
    public static int t3duration;
    public static final int T3DURATION_DEFAULT = 6000;
    public static final String T3DURATION_DESCRIPTION = "Duration of the effect for T1 Instruments";
