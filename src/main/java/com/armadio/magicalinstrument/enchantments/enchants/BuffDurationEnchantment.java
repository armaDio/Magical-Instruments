...
public class BuffDurationEnchantment extends Enchantment implements InstrumentEnchants {
    public BuffDurationEnchantment(Rarity p_44676_, EquipmentSlot... p_44678_) {
