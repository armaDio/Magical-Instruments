package com.armadio.magicalinstrument.tileentities;
 ...
 */
public class TileEntityBossAltar extends TileEntity implements IInventory{

    ArrayList<ItemStack> items = new ArrayList<ItemStack>(1);

    public boolean shouldDrop(){
        return items.get(0).isItemEqual(new ItemStack(Items.nether_star));
    }

    public TileEntityBossAltar(){
    ...
    public boolean isItemValidForSlot(int p_94041_1_, ItemStack p_94041_2_) {
        return (p_94041_2_.getUnlocalizedName().equals(Items.nether_star.getUnlocalizedName()));
    }
