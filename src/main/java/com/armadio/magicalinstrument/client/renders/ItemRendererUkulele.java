 ...
 */
public class ItemRendererUkulele implements IItemRenderer {

    private int tier;
    protected ModelUkulele ukulele;

    public ItemRendererUkulele(int tier){
        ukulele = new ModelUkulele();
        this.tier = tier;
    }
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        switch (type){
            ...
            case EQUIPPED_FIRST_PERSON:
                ...
                Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation(Reference.MOD_ID,"textures/models/UkuleleTexture"+tier+".png"));
